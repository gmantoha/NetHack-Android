...
## Preparations
 ...
 - Install JDK 17. Required by the Android Gradle Plugin (e.g. [https://adoptium.net/temurin/releases?version=17&os=any&arch=any](Temurin))
...
### Install Android build tools
 ...
 3. Install the platform tools: `./sdkmanager --install "platforms;android-35"`
 4. Install the NDK: `./sdkmanager --install "ndk;26.3.11579264"`
